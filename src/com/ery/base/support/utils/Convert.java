...
public class Convert {
	...
	if (object == null) {
	    ...
	    LocalDateTime lct = LocalDateTime.class.cast(object);
	    GregorianCalendar c = new GregorianCalendar(lct.getYear(), lct.getMonthValue() - 1, lct.getDayOfMonth(),
		    lct.getHour(), lct.getMinute(), lct.getSecond());
	    if (clazz.equals(Date.class)) {
		t = clazz.cast(new Date(c.getTimeInMillis()));
	    } else if (clazz.equals(java.sql.Date.class)) {
		t = clazz.cast(new java.sql.Date(c.getTimeInMillis()));
	    }
	} else {
	    t = clazz.cast(object);
	}
