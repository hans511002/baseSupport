...
public class ClassUtils {
	...
	public static List<Class<?>> getClasses(String packageName, Class c) throws ClassNotFoundException, IOException {
	...
	public static void findClassesByFile(List<Class<?>> classes, String packageName, String packagePath, Class c) {
	...
	public static void findClassesByJar(String basePackage, URL url, List<Class<?>> classes, Class c) {
